 ...
 * @author Ashane
 */
public class DepDBConnection extends DBConnection{
    
    
    public void deleteData(String department,String designation,String fileName) {
        
        String uniqueKey=department+","+designation;
        String input;
