...
public abstract class DBConnection {
    ...
    public DBConnection() {
        this.Filter = "Filter.txt";
        this.userFile = "User.txt";
    }
    ...
    public void editData( String oldCode, String newString,String filename)
    {
        ...
        try {
            ...
            if(found1) {
                ...
                JOptionPane.showMessageDialog(null, "The details entered doesn't exist in the list!",
