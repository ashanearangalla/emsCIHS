...
public class UserLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextFieldUsername.getText().equals("")|| jPasswordField1.getText().equals("")){
            ...
            obj.setUsername(jTextFieldUsername.getText().toString());
            String passText = new String(jPasswordField1.getPassword());
            obj.setPassword(passText);

            UserDBConnection myobj=new UserDBConnection();

            User user= myobj.loginValidation(obj);

            if(user.getUserType()!=null) {

                if("Admin".equals(user.getUserType())){
                ManageUserAccounts manageuser = new ManageUserAccounts();
                manageuser.jLabelUsernameUserAcc.setText(user.getUsername());
                manageuser.show();
                dispose();

            }else{
                ManagerHomePage managerMenu = new ManagerHomePage();
                managerMenu.jLabelUsername.setText(user.getUsername());
                managerMenu.show();
